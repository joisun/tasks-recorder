...
const drawerVariants = tv({
  slots: {
    ...
    indentBackground:
      "pointer-events-none fixed inset-0 z-0 bg-overlay transition-opacity duration-500 ease-fluid-out data-[active]:opacity-100 data-[inactive]:opacity-0",
  },
  variants: {
    placement: {
      top: {
...
interface DrawerProps {
  ...
  finalFocus?: DrawerPrimitive.Popup.Props["finalFocus"];
...
function Drawer({
  ...
  if (state.isOpen && !wasOpenRef.current && typeof document !== "undefined") {
      ...
      >
        ...
        <DrawerPrimitive.VirtualKeyboardProvider>
          <DrawerPrimitive.Portal>
            <ClearPressResponder>
              <div className={overlay({ className: modal ? undefined : "pointer-events-none" })}>
                {modal ? <DrawerPrimitive.Backdrop className={backdrop()} /> : null}
                  ...
                  <DrawerPrimitive.Popup
                    ...
                    className={(state) =>
                      popup({
                        placement,
                        className: [
                          modal ? undefined : "pointer-events-auto",
