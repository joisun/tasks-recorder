  ...
  try {
    ...
    assert.deepEqual(
      ...
      [
        ...
        'agent_tasks_sync_structure', 'agent_tasks_sync_tree', 'agent_tasks_update',
        'agent_tasks_upsert', 'agent_work_attribution_correct', 'agent_work_checkpoint',
        'agent_work_context', 'agent_work_focus', 'agent_work_intent',
      ],
    )
